...
var Card = (function (window, undefined) {
    ...
    var CardFactory = {
            ...
            /**
             * Entry-point function that set up the card's
             * opening animations, and passes a callback through
             * to the floatContainer animation
             */
        ...
        Card = function () {
            return Object.create(CardFactory);
        };
